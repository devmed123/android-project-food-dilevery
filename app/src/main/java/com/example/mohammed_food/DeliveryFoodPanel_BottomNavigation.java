...
import com.example.mohammed_food.deliveryFoodPanel.DeliveryPendingOrderFragment;
import com.example.mohammed_food.deliveryFoodPanel.DeliveryShipOrderFragment;
...
public class DeliveryFoodPanel_BottomNavigation extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delivery_food_panel_bottom_navigatio);
